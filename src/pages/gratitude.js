...
const GratitudeIndex = ({data, location}) => {
  ...
  5. Packed up all my things and was ready to move to Waterloo.
  ...
  1. My roommate hosted a small dinner party which was lots of fun and it gave me an opportunity to get to know everyone there.
  ...
  return (
    <Layout location={location} title={siteTitle}>
        <Seo title="Gratitude" />
        <Navbar></Navbar>
        <ReactMarkdown>{gratitudeContent}</ReactMarkdown> 
        <Bio />    
    </Layout>
  )
}
